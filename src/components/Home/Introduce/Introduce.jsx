            ...
            <div className="max-w-7xl px-5 mx-auto">
                <div className="grid grid-cols-12 gap-5">
                    ...
                    <div className="col-span-8">
                        ...
                        <p className="mt-4">Trung tâm Du học Nhật Bản Hello Japan là đơn vị chuyên về tư vấn Du học Nhật Bản tại Việt Nam. Trong quá trình hoạt động của mình, Hello Japan luôn là một trong những thương hiệu có uy tín nhất theo đánh giá của Khách hàng và Đối tác.</p>
